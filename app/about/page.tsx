      ...
      <main className="mx-auto max-w-2xl px-4 pb-16 pt-8">
        <article className="theme-surface rounded-[2rem] border p-7 sm:p-10">
          ...
          <div className="mt-6 space-y-4 leading-7 text-slate-600 dark:text-slate-300">
            ...
            <p>The five-game lineup includes NeedleDrop, Minefield, Top 3, SpellDrop, and Closer—recognition, risk, recall, spelling, and numeric instinct in one quick daily run.</p>
