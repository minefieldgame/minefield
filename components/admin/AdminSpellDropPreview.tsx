    ...
    <section className="theme-surface rounded-[2rem] border p-5 sm:p-6">
      ...
      <div className="mt-3 grid gap-2 sm:grid-cols-2">
        {[
          ...
          ["Game ID", preview.diagnostics.resolverDiagnostics.gameId ?? "spelldrop"],
          ["Daily seed", preview.diagnostics.resolverDiagnostics.seed ?? "—"],
          ["Temperature", preview.diagnostics.resolverDiagnostics.temperature ?? 0],
          ["Regenerated this session", String(preview.diagnostics.resolverDiagnostics.regeneratedThisSession ?? false)],
    ...
    <section className="theme-surface rounded-[2rem] border p-5 sm:p-6">
      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-2">
        {[
          ...
          ["Game ID", preview.diagnostics.gameId ?? "spelldrop"],
          ...
          ["Generation mode", preview.generator],
