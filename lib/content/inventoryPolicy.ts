...
export type ContentHealthStatus = "Healthy" | "Low eligible inventory" | "Critically low eligible inventory" | "Exhausted" | "Provider unavailable" | "Quality gate failure" | "Infrastructure failure";
